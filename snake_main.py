...
# while True:
#     print("score:", score)  # In điểm số trò chơi
...
#             else:
#                 best_move = None
#                 best_move_score = -1  # Đổi tên để tránh nhầm lẫn với score của trò chơi
#                 for move, (dx, dy) in moves:
#                     new_pos = [snake_pos[0] + dx, snake_pos[1] + dy]
#                     if is_safe(new_pos, snake_body):
#                         move_score = evaluate_move(new_pos, snake_body, snake_pos, tail)  # Đổi tên thành move_score
...
#         y = random.randrange(0, HEIGHT, CELL_SIZE)  # Tránh hàng cuối cùng
#         if [x, y] not in snake_body:
#             return [x, y]

# snake_pos = [0, 0]  # Bắt đầu từ góc trên bên trái
# snake_body = [[0, 0], [0, 20], [0, 40]]  # Khởi tạo rắn ở tường trái
# food_pos = random_food()
# food_spawned = True

# direction = 'DOWN'  # Bắt đầu đi xuống
# change_to = direction
# state = 'DOWN'  # Trạng thái: DOWN, RIGHT_DOWN, UP, RIGHT_UP, RETURN_LEFT
...
# def get_safe_move(current_pos, preferred_direction, snake_body):
#     for move, (dx, dy) in moves:
...
#                 return move
#     for move, (dx, dy) in moves:
#         if move != opposite_directions.get(direction):
#             new_pos = [current_pos[0] + dx, current_pos[1] + dy]
#             if is_safe(new_pos, snake_body):
#                 return move
#     return None
...
# while True:
#     print("score:", score, "state:", state, "position:", snake_pos)
#     for event in pygame.event.get():
#         if event.type == pygame.QUIT:
#             pygame.quit()
#             sys.exit()
...
#     if state == 'DOWN':
#         if snake_pos[1] < HEIGHT - 2 * CELL_SIZE and is_safe([snake_pos[0], snake_pos[1] + CELL_SIZE], snake_body):
#             change_to = 'DOWN'
#         else:
#             change_to = get_safe_move(snake_pos, 'RIGHT', snake_body)
#             if change_to:
#                 state = 'RIGHT_DOWN'
#             else:
#                 print("No safe move found, game over")
...
#         change_to = get_safe_move(snake_pos, 'UP', snake_body)
#         if change_to:
#             state = 'UP'
#         else:
#             print("No safe move found, game over")
...
#     elif state == 'UP':
#         if snake_pos[1] > 0 and is_safe([snake_pos[0], snake_pos[1] - CELL_SIZE], snake_body):
#             change_to = 'UP'
#         else:
#             change_to = get_safe_move(snake_pos, 'RIGHT', snake_body)
#             if change_to:
...
#     elif state == 'RIGHT_UP':
#         change_to = get_safe_move(snake_pos, 'DOWN', snake_body)
#         if change_to:
#             state = 'DOWN'
#         else:
#             print("No safe move found, game over")
...
#     elif state == 'RETURN_LEFT':
#         if snake_pos[0] > 0 and is_safe([snake_pos[0] - CELL_SIZE, snake_pos[1]], snake_body):
#             change_to = 'LEFT'
#         else:
#             change_to = get_safe_move(snake_pos, 'DOWN', snake_body)
#             if change_to:
...
#     if snake_pos[0] >= WIDTH - CELL_SIZE and state != 'RETURN_LEFT':
#         if snake_pos[1] < HEIGHT - CELL_SIZE and is_safe([snake_pos[0], snake_pos[1] + CELL_SIZE], snake_body):
#             change_to = 'DOWN'
#             state = 'RETURN_LEFT'
#         else:
#             print("No safe move to bottom, game over")
#             pygame.quit()
#             sys.exit()
